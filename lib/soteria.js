...
function Soteria() {
	...
	var createOriginProxy = function createOriginProxy(request, requestId, 
														response) {
	...
	var createCandidateRequest = function createCandidateRequest(request, 
																requestId) {
	...
	var createLogData = function createLogData(data, requestId, target) {
		var json = {};
		if(data) {
			try {
	...
	this.server = http.createServer(function(request, response) {
		...
		var requestId = cuid();
		createOriginProxy(request, requestId, response);
	    createCandidateRequest(request, requestId);
